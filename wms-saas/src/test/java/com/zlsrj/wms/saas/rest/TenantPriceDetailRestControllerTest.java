...
public class TenantPriceDetailRestControllerTest {
	...
	public void pageTest() throws Exception {
		...
		// params.add("id",TestCaseUtil.id());// 水价明细ID
		// params.add("tenantId",RandomUtil.randomString(4));// 租户ID
		// params.add("priceId",RandomUtil.randomString(4));// 水表列表ID
		// params.add("priceItemId",RandomUtil.randomString(4));// 费用项目
		// params.add("priceRuleId",RandomUtil.randomString(4));// 计费规则
		// params.add("detailPrice",new BigDecimal(0));// 单价
