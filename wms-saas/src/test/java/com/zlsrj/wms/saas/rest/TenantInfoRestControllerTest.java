...
public class TenantInfoRestControllerTest {
	...
	public void pageTest() throws Exception {
		...
		// params.add("tenantProvince",TestCaseUtil.province());// 省（下拉框）
		// params.add("tenantCity",TestCaseUtil.city());// 市（下拉框）
		// params.add("tenantCountyTown",RandomUtil.randomString(4));// 区县（下拉框）
		...
		// params.add("tenantType",RandomUtil.randomInt(0,1+1));// 租户类型（1使用单位/2水表厂商/3代收机构/4内部运营/5分销商）
		// params.add("tenantRegisterTime",new Date());// 注册时间
		// params.add("invoiceType",RandomUtil.randomInt(0,1+1));// 开票类别（1普通纸制发票/2普通电子发票/3专用纸制发票）
	...
	public void saveTest() throws Exception {
		...
		TenantInfo tenantInfo = TenantInfo.builder()//
				...
				.tenantType(RandomUtil.randomInt(0,1+1))// 租户类型（1使用单位/2水表厂商/3代收机构/4内部运营/5分销商）
				.tenantRegisterTime(new Date())// 注册时间
				.invoiceType(RandomUtil.randomInt(0,1+1))// 开票类别（1普通纸制发票/2普通电子发票/3专用纸制发票）
