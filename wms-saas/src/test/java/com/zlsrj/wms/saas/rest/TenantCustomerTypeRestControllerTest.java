...
public class TenantCustomerTypeRestControllerTest {
	...
	public void pageTest() throws Exception {
		...
		// params.add("id",TestCaseUtil.id());// 用户类别ID
		// params.add("tenantId",RandomUtil.randomLong());// 租户ID
		// params.add("customerTypeName",TestCaseUtil.name());// 用户类别名称
		// params.add("customerTypeParentId",RandomUtil.randomLong());// 上级用户类别ID
