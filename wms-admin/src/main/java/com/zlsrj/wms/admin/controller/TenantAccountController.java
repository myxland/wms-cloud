...
public class TenantAccountController {
	...
	@ResponseBody
	public CommonResult<TenantAccountVo> getById(@PathVariable("id") String id) {
	...
	@ResponseBody
	public CommonResult<TenantAccountVo> getByTenantId(@PathVariable("tenantId") String tenantId) {
