...
public class TenantSmsRestControllerTest {
	...
	public void pageTest() throws Exception {
		...
		// params.add("smsSignature",RandomUtil.randomString(4));// 签名
		// params.add("smsSpService",RandomUtil.randomString(4));// SP服务商
		// params.add("smsReadSendOn",RandomUtil.randomInt(0,1+1));// 抄表账单通知
		// params.add("smsChargeSendOn",RandomUtil.randomInt(0,1+1));// 缴费成功通知
