...
@Getter
@Setter
@ApiModel(value = "TenantCustomerContacts更新参数", description = "用户联系方式")
public class TenantCustomerContactsUpdateParam implements Serializable {

	private static final long serialVersionUID = 1513815344885151581L;
