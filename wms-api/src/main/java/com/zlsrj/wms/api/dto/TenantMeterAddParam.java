...
@Getter
@Setter
@ApiModel(value = "TenantMeter新增参数", description = "水表信息")
public class TenantMeterAddParam implements Serializable {

	private static final long serialVersionUID = 1921353146714433861L;
