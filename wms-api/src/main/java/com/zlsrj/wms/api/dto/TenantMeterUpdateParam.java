...
@Getter
@Setter
@ApiModel(value = "TenantMeter更新参数", description = "水表信息")
public class TenantMeterUpdateParam implements Serializable {

	private static final long serialVersionUID = 1447951155104123915L;
