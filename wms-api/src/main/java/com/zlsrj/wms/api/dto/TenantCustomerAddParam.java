...
@Getter
@Setter
@ApiModel(value = "TenantCustomer新增参数", description = "用户信息")
public class TenantCustomerAddParam implements Serializable {

	private static final long serialVersionUID = 7612151501373120139L;
