...
@Getter
@Setter
@ApiModel(value = "TenantCustomerStatement新增参数", description = "用户结算信息")
public class TenantCustomerStatementAddParam implements Serializable {

	private static final long serialVersionUID = 8021151214614101483L;
