...
@Getter
@Setter
@ApiModel(value = "TenantPrice更新参数", description = "水价列表")
public class TenantPriceUpdateParam implements Serializable {
	...
	private List<TenantPriceDetailUpdateParam> tenantPriceDetailList;
}
