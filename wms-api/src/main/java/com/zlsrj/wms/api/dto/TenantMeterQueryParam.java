...
public class TenantMeterQueryParam implements Serializable {
	...
	@ApiModelProperty(value = "最近抄表日期开始")
	private Date meterReadDateStart;

	@ApiModelProperty(value = "最近抄表日期结束")
	private Date meterReadDateEnd;
	...
	@ApiModelProperty(value = "最近计费日期开始")
	private Date meterSettleDateStart;

	@ApiModelProperty(value = "最近计费日期结束")
	private Date meterSettleDateEnd;
	...
	@ApiModelProperty(value = "阶梯起算日开始")
	private Date meterPriceStepDateStart;

	@ApiModelProperty(value = "阶梯起算日结束")
	private Date meterPriceStepDateEnd;
