...
@Getter
@Setter
@ApiModel(value = "DevReadCurr查询参数", description = "抄表信息")
public class DevReadCurrQueryParam implements Serializable {

	private static final long serialVersionUID = 5551574011712646421L;
