...
@Getter
@Setter
@ApiModel(value = "ModuleInfo更新参数", description = "模块信息")
public class ModuleInfoUpdateParam implements Serializable {
