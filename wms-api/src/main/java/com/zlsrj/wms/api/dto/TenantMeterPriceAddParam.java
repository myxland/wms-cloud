...
@Getter
@Setter
@ApiModel(value = "TenantMeterPrice新增参数", description = "水表计费")
public class TenantMeterPriceAddParam implements Serializable {

	private static final long serialVersionUID = 1904068135312312309L;
