...
@Getter
@Setter
@ApiModel(value = "TenantCustomerArchives更新参数", description = "用户档案")
public class TenantCustomerArchivesUpdateParam implements Serializable {

	private static final long serialVersionUID = 5206147115115799152L;
