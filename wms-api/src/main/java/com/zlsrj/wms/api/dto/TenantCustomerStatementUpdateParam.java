...
@Getter
@Setter
@ApiModel(value = "TenantCustomerStatement更新参数", description = "用户结算信息")
public class TenantCustomerStatementUpdateParam implements Serializable {

	private static final long serialVersionUID = 1051593171114410148L;
