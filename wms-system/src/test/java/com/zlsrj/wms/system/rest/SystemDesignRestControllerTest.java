...
@SpringBootTest
@Slf4j
public class SystemDesignRestControllerTest {
	...
	public void getByIdTest() throws Exception {
		Long id = 1L;
		String responseString = mockMvc.perform(MockMvcRequestBuilders.get("/system-designs" + "/" + id))
	...
	public void pageTest() throws Exception {
		...
		String responseString = mockMvc.perform(MockMvcRequestBuilders.get("/system-designs").params(params))
				.andExpect(MockMvcResultMatchers.status().isOk()) // 返回的状态是200
				.andDo(MockMvcResultHandlers.print()) // 打印出请求和相应的内容
				.andReturn().getResponse().getContentAsString();
		log.info(responseString);
	...
	public void saveTest() throws Exception {
		...
		SystemDesign tenantInfo = SystemDesign.builder()//
		...
		String responseString = mockMvc
				.perform(MockMvcRequestBuilders.post("/system-designs").content(JSON.toJSONString(tenantInfo)) //
	...
	public void updateByIdTest() throws Exception {
		...
		String responseString = mockMvc
				.perform(MockMvcRequestBuilders.put("/system-designs" + "/" + id).content(JSON.toJSONString(tenantInfo)) //
						.contentType(MediaType.APPLICATION_JSON_UTF8) // 数据的格式
						.accept(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(MockMvcResultMatchers.status().isOk()) // 返回的状态是200
				.andDo(MockMvcResultHandlers.print()) // 打印出请求和相应的内容
	...
	public void updatePatchById() throws Exception {
		...
		String responseString = mockMvc
				.perform(MockMvcRequestBuilders.patch("/system-designs" + "/" + id).content(JSON.toJSONString(tenantInfo)) //
						.contentType(MediaType.APPLICATION_JSON_UTF8) // 数据的格式
						.accept(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(MockMvcResultMatchers.status().isOk()) // 返回的状态是200
				.andDo(MockMvcResultHandlers.print()) // 打印出请求和相应的内容
	...
	public void removeById() throws Exception {
		...
		String responseString = mockMvc.perform(MockMvcRequestBuilders.delete("/system-designs" + "/" + id)) //
				.andExpect(MockMvcResultMatchers.status().isOk()) // 返回的状态是200
				.andDo(MockMvcResultHandlers.print()) // 打印出请求和相应的内容
				.andReturn().getResponse().getContentAsString(); // 将相应的数据转换为字符
		log.info(responseString);
