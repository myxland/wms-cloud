...
public class GeneratorSQLTest {
	...
	@Value("${avatar.projectNameFlyway}")
	private String projectNameFlyway;
	...
	@Value("${avatar.artifactIdFlyway}")
	private String artifactIdFlyway;
	...
	public void generator() {
		...
		dataModel.put("artifactIdFlyway", artifactIdFlyway);
		dataModel.put("projectNameApi", projectNameApi);
		dataModel.put("projectNameWeb", projectNameWeb);
		dataModel.put("projectNameFlyway", projectNameFlyway);
		dataModel.put("projectNameVue", projectNameVue);
		
		String version = DateTime.now().toString(DatePattern.PURE_DATETIME_PATTERN);
		dataModel.put("version", version);
		dataModel.put("databaseSchema", databaseSchema);
		...
		try {
			...
			Template template = configuration.getTemplate("pathSQL.ftl", encode);
