...
public class ${table.entityName}ControllerTest {
	...
	public void createTest() throws Exception {
		...
		${table.entityName?uncap_first}AddParam.set${column.propertyName?cap_first}("${column.columnComment}"+"-"+"新增用例"+"-"+RandomUtil.randomNumbers(4));// ${column.columnComment}
	...
	public void countTest() throws Exception {
		...
		String responseString = mockMvc.perform(//
				MockMvcRequestBuilders.get("/${table.entityName?uncap_first}/count")//
						.params(params)
						.accept(MediaType.APPLICATION_JSON_UTF8)//
		).andReturn().getResponse().getContentAsString();
		log.info(responseString);
	...
	public void updateTest() throws Exception {
		...
		<#list table.columnList as column>
		<#if "id" == column.columnName || "tenant_id" == column.columnName>
		<#elseif column.columnName?ends_with("tenant_name")>
		...
		<#elseif column.columnName?ends_with("_name") || column.columnName?ends_with("_linkman")>
		${table.entityName?uncap_first}UpdateParam.set${column.propertyName?cap_first}("${column.columnComment}"+"-"+"新增用例"+"-"+RandomUtil.randomNumbers(4));// ${column.columnComment}
		<#elseif column.columnName?ends_with("_province")>
