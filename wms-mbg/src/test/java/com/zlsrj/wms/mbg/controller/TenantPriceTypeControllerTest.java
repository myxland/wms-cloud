...
@SpringBootTest
@Slf4j
public class TenantPriceTypeControllerTest {
	...
	public void getByIdTest() throws Exception {
		Long id = 1L;
		String responseString = mockMvc.perform(MockMvcRequestBuilders.get("/tenantPriceType/select" + "/" + id)).andReturn()
	...
	public void listTest() throws Exception {
		String responseString = mockMvc.perform(MockMvcRequestBuilders.get("/tenantPriceType/list")).andReturn()
				.getResponse().getContentAsString();
		log.info(responseString);
	}
	...
	public void pageTest() throws Exception {
		...
		String responseString = mockMvc.perform(MockMvcRequestBuilders.get("/tenantPriceType/page").params(params))
	...
	public void insertTest() throws Exception {
		...
		String responseString = mockMvc
				.perform(MockMvcRequestBuilders.post("/tenantPriceType/insert").content(JSONUtil.toJsonStr(tenantPriceType)) // 请求的url,请求的方法是get
	...
	public void updateTest() throws Exception {
		...
		String responseString = mockMvc
				.perform(MockMvcRequestBuilders.put("/tenantPriceType/update").content(JSONUtil.toJsonStr(tenantPriceType)) // 请求的url,请求的方法是get
						.contentType(MediaType.APPLICATION_JSON_UTF8) // 数据的格式
						.accept(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(MockMvcResultMatchers.status().isOk()) // 返回的状态是200
				.andDo(MockMvcResultHandlers.print()) // 打印出请求和相应的内容
	...
	public void updateStatusTest() throws Exception {
		...
		String responseString = mockMvc
				.perform(MockMvcRequestBuilders.put("/tenantPriceType/update" + "/" + id + "/status" + "/" + status)
						.accept(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(MockMvcResultMatchers.status().isOk()) // 返回的状态是200
				.andDo(MockMvcResultHandlers.print()) // 打印出请求和相应的内容
				.andReturn().getResponse().getContentAsString(); // 将相应的数据转换为字符
	...
	public void deleteTest() throws Exception {
		...
		String responseString = mockMvc
				.perform(MockMvcRequestBuilders.delete("/tenantPriceType/delete" + "/" + id)
						.accept(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(MockMvcResultMatchers.status().isOk()) // 返回的状态是200
				.andDo(MockMvcResultHandlers.print()) // 打印出请求和相应的内容
				.andReturn().getResponse().getContentAsString(); // 将相应的数据转换为字符
	...
	public void deleteByIdsTest() throws Exception {
		...
		String responseString = mockMvc
				.perform(MockMvcRequestBuilders.delete("/tenantPriceType/delete/ids" + "/" + StringUtils.join(list, ','))
						.accept(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(MockMvcResultMatchers.status().isOk()) // 返回的状态是200
				.andDo(MockMvcResultHandlers.print()) // 打印出请求和相应的内容
				.andReturn().getResponse().getContentAsString(); // 将相应的数据转换为字符
